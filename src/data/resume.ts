...
export const projects: Project[] = [
  {
    name: '安卓指趣游戏盒的H5活动页',
    description: '在安卓游戏盒的 H5 页面中，为了引流和吸引用户，开发了一些活动页，例如：`畅玩卡`、`指悦会员`、`抽奖`等；项目使用 Vue2 开发，使用 dsbridge 进行与安卓原生的交互, 了解 web 页面与安卓原生在 Webview 中的交互方式',
  ...
  {
    name: '公司内部的后台管理系统',
    description: '日常迭代和维护指趣游戏盒后台、指趣SDK后台、开发者后台等各类后台管理系统',
    technologies: 'Vue2、TS等...',
  },
  {
    name: '指趣游戏盒-iOS-H5版本',
    description: '在iOS-Safari中运行的指趣游戏盒简化版本',
  ...
  {
    name: '闪趣官网',
    description: '公司官网，响应式，兼容PC端和移动端',
    technologies: 'Vue2、TS、CSS媒体查询等...',
  },
  {
    name: '【个人项目】vue3-ui',
    description: 'Vue3组件库，已实现Table、Watermark等42个常用组件，有基本的单元测试、说明文档',
    links: [
  ...
  },
  {
    ...
    description: 'Flutter仿Github客户端App，主要实现首页、repo相关页、issue相关页、starred相关页、个人资料页',
  ...
  },
  {
    ...
    description: '使用hbuilderx、uniapp结合unicloud开发的微信小程序文章demo，包括微信小程序登录、uni-id鉴权、文章增删改查、用户个人资料修改等功能',
